...
if __name__ == '__main__':
    ...
    data_name = "cancer"
    train_dir = f"art_without_edge/nodes_cnn/{data_name}/"
    ...
    train_files = list(train_dir.glob(f"*{data_name}_cnn.dat"))
    ...
    for train_file, test_file in zip(train_files, test_files):
        ...
        args[experiment_id_index] = experiment_id+"_cnn"
