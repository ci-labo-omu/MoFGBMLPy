...
if __name__ == '__main__':
    ...
    args = [
        ...
        "--experiment-id", "2",
        "--data-name", "bupa",
        "--train-file", "../dataset/bupa/a0_4_bupa-10tra.dat",
        "--test-file", "../dataset/bupa/a0_4_bupa-10tst.dat",
        "--terminate-evaluation", "40000",
    ...
    runner.plot_line_interpretability_error_rate_tradeoff(results.opt.get('X')[:, 0],
                                                          title="MoFGBMLPy on Bupa with NSGA-II", xlim=[0, 51])
