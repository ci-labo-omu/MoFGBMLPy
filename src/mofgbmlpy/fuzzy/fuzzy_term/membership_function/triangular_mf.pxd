...
cdef extern from "core/fuzzy/fuzzy_term/membership_function/triangular_mf.hpp":
    cdef cppclass TriangularMFCpp "TriangularMF"(AbstractMFCpp):
        TriangularMFCpp(float left, float center, float right) except +;
