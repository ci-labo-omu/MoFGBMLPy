...
#include "../../../fuzzy/rule/consequent/ruleWeight/abstract_rule_weight.hpp"
...
public:
    ...
    virtual std::shared_ptr<AbstractClassLabel> get_class_label() const = 0;
    ...
    virtual std::shared_ptr<AbstractRuleWeight> get_rule_weight() const = 0;
    virtual void set_rule_weight(std::shared_ptr<AbstractRuleWeight> rule_weight) = 0;
