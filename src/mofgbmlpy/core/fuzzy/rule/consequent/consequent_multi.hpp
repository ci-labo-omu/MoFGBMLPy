...
private:
    ClassLabelMulti* class_label;
    RuleWeightMulti* rule_weight;

public:
    ConsequentMulti(ClassLabelMulti* class_label,
                    RuleWeightMulti* rule_weight);
    ConsequentMulti(const ConsequentMulti& other);

    AbstractClassLabel* get_class_label() const override;
    void set_class_label_value(std::vector<int> class_label_value);
    std::vector<int> get_class_label_value() const;

    AbstractRuleWeight* get_rule_weight() const override;
    void set_rule_weight(AbstractRuleWeight* rule_weight) override;
