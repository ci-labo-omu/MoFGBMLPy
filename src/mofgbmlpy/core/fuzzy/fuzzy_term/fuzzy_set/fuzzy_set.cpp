...
FuzzySet::FuzzySet(AbstractMF* function, int id, DivisionType division_type, std::string term)
...
AbstractMF* FuzzySet::get_function() const {
    return function;
}

void FuzzySet::set_function(AbstractMF* new_function) {
    this->function = std::move(new_function);
}
