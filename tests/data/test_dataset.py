...
def test_negative_size():
    p = np.array([Pattern(0, np.array([0.0, 1.0, 2.0], dtype=np.float64), ClassLabelBasic(0))], dtype=object)
...
def test_get_pattern():
    ...
    p2 = Pattern(0, np.array([3.0, 4.0, 5.0], dtype=np.float64), ClassLabelBasic(1))
...
def test_eq_false_different_patterns_order():
    p1 = Pattern(0, np.array([0.0, 1.0, 2.0], dtype=np.float64), ClassLabelBasic(0))
    p2 = Pattern(0, np.array([0.0, 2.0, 1.0], dtype=np.float64), ClassLabelBasic(0))
...
def test_eq_different_patterns():
    p1 = Pattern(0, np.array([0.0, 1.0, 2.0], dtype=np.float64), ClassLabelBasic(0))
    p2 = Pattern(0, np.array([0.0, 0.0, 2.0], dtype=np.float64), ClassLabelBasic(0))
    ds1 = Dataset(1, 3, 1, np.array([p1], dtype=object))
    ds2 = Dataset(1, 3, 1, np.array([p2], dtype=object))
...
def test_eq_different_num_dim():
    p1 = Pattern(0, np.array([0.0, 1.0, 2.0], dtype=np.float64), ClassLabelBasic(0))
    p2 = Pattern(0, np.array([0.0, 0.0], dtype=np.float64), ClassLabelBasic(0))
    ds1 = Dataset(1, 3, 1, np.array([p1], dtype=object))
